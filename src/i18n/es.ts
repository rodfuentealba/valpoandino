export const es = {
  ...
  chilcasPage: {
    ...
    routeSchoolText: '"Ni lo uno ni lo otro, sino todo lo contrario" (5+), "Leidimar" (5+/6a) y "Pepita azul" (5–). Perfectas para quienes se inician en la escalada deportiva.',
    routeExpert: 'Rutas de expertos',
    routeExpertText: '"Simpatía por el diablo" (8a) y "Si los perros ladran" (8c) son algunos de los desafíos que esperan a los escaladores más experimentados.',
