...
export default function Chilcas() {
  ...
  return (
    <section id="chilcas" className="relative w-full h-[360px] md:min-h-screen bg-white dark:bg-zinc-900 overflow-hidden">
      ...
      <div className="relative z-10 w-full flex items-center justify-center py-8 md:py-2">
        <img
      ...
      <div className="absolute top-20 md:top-[10%] right-[15%] z-20 translate-y-1/2 bg-red-400 p-2">
